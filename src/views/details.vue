      ...
      <ul style="background: white;">
        <li v-for="(goodDetail, index) in goodDetails" :key="goodDetail.id">
          <div class="goodDetaiSwipe">
            <mt-swipe :auto="4000">
              <mt-swipe-item>
                <img v-bind:src="goodDetail.imgone" alt="图片" />
              </mt-swipe-item>
              <mt-swipe-item>
                <img v-bind:src="goodDetail.imgtwo" alt="图片" />
              </mt-swipe-item>
              <mt-swipe-item>
                <img v-bind:src="goodDetail.imgThree" alt="图片" />
              </mt-swipe-item>
            </mt-swipe>
          </div>
          ...
          <div class="goodDetailValue">
            ...
            <div class="_cartNumber" style="margin-left: 2rem;">
              ...
              <input
                type="text"
                v-model="goodDetail.value"
                readonly="readonly"
              />
              <a href="javascript:;" @click="jia(index)" class="goodDetailAdd"
                >+</a
              >
            </div>
          </div>
            ...
            <mt-tab-container v-model="selected" swipeable>
              ...
              <mt-tab-container-item id="tab-container2">
                <div class="goodDetailPeizhi">
                  <table
                    style="width: 100%;border:1px solid #cccccc;margin-top: 5px;border-collapse: collapse;margin-bottom: 10px;"
                    border="1"
                  >
                    <tbody>
                      <tr v-for="(Peizhi,index) in goodDetail.Peizhis" :key="index">
...
import {shopDetail} from "@/mock/shopList.js";
export default {
  name: "goodDetail",
  data() {
    return {
